 ...
 */
import { VersionedMutationRequestSchema } from "../../../src/catalog/erpnext-item-map/dto/versioned-mutation-request.dto";

const INT4_MAX = 2147483647;

describe("item-map VersionedMutationRequest version int4 bound", () => {
